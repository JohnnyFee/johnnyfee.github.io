...
> 原文：[如何使用NPM来管理你的Node.js依赖](http://www.infoq.com/cn/articles/msh-using-npm-manage-node.js-dependence)
> 
> 作者：马士华，崇尚技术，爱好开源。twitter : @mashihua 博客 [http://www.f2eskills.com/](http://www.f2eskills.com/)
...
- [cnpm/cnpm](https://github.com/cnpm/cnpm) cnpm: npm client for cnpmjs.org
- [cnpm/cnpmjs.org](https://github.com/cnpm/cnpmjs.org) Private npm registry and web for Enterprise, base on MySQL and Simple Store Service. <http://cnpmjs.org>
...
5. 内置的配置。通过安装时运行 ./configure 所定义的变量。可通过命令curl [http://npmjs.org/install.sh](http://npmjs.org/install.sh) | env npm_config_foo=bar sh 设置。

使用配置能给我们带来很大的灵活性。比如我们使用 npm install 时，对默认的资源库地址 [https://registry.npmjs.org/](https://registry.npmjs.org/) 不是很满意，我们可以使用下面的命令来更改资源库地址。
...
- [Introduction to npm | Flippin' Awesome](http://flippinawesome.org/2014/03/31/introduction-to-npm/)