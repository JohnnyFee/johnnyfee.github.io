...
原文：[QtWebKit Guide - Client Storage | Documentation | Qt Project](http://qt-project.org/doc/qt-4.8/qtwebkit-guide-cache.html)
...
[![](images/scr_storage.png)](http://qt-project.org/doc/qt-4.8/images/scr_storage.png)

[(CSS)](webkit-webkit-guide-css-storage-css.html)[(JavaScript)](webkit-webkit-guide-js-storage-js.html)
