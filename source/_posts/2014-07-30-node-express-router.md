...
Code: <https://github.com/scotch-io/express-router-experiments>
...
## [Overview](http://scotch.io/tutorials/javascript/learn-to-use-the-new-router-in-expressjs-4#overview)
...
## [Our Sample Application](http://scotch.io/tutorials/javascript/learn-to-use-the-new-router-in-expressjs-4#our-sample-application)
...
## [Application Structure](http://scotch.io/tutorials/javascript/learn-to-use-the-new-router-in-expressjs-4#application-structure)
...
## [Starting Our Application](http://scotch.io/tutorials/javascript/learn-to-use-the-new-router-in-expressjs-4#starting-our-application)
...
## [Creating Our Server](http://scotch.io/tutorials/javascript/learn-to-use-the-new-router-in-expressjs-4#creating-our-server)
...
## [Express Router](http://scotch.io/tutorials/javascript/learn-to-use-the-new-router-in-expressjs-4#express-router)
...
## [Basic Routes express.Router()](http://scotch.io/tutorials/javascript/learn-to-use-the-new-router-in-expressjs-4#basic-routes-express.router())
...
## [Route Middleware router.use()](http://scotch.io/tutorials/javascript/learn-to-use-the-new-router-in-expressjs-4#route-middleware-router.use())
...
## [Route with Parameters /hello/:name](http://scotch.io/tutorials/javascript/learn-to-use-the-new-router-in-expressjs-4#route-with-parameters-/hello/:name)
...
## [Conclusion](http://scotch.io/tutorials/javascript/learn-to-use-the-new-router-in-expressjs-4#conclusion)
