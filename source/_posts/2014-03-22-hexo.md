...
- 主题：[Themes · tommy351/hexo Wiki](https://github.com/tommy351/hexo/wiki/Themes)
...
当你需要在文章中插入如 {% raw %} {% %} {% endraw %}的字符时，请使用以下以下注释：

    {% raw %}
        {% raw %} and {% endraw %}
    {% endraw %}

参考：[Make swig optional for certain files? · Issue #30 · tommy351/hexo](https://github.com/tommy351/hexo/issues/30)
