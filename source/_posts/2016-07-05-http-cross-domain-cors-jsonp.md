layout: post
title: "JavaScript Http Cross Domain"
description: ""
category: JavaScript
tags: [javascript, http, cross domain, cors, jsonp]
---

See [详解js跨域问题 - trigkit4 - SegmentFault](https://segmentfault.com/a/1190000000718840)
...
这个时候，`document.domain`就可以派上用场了，我们只要把`http://www.example.com/a.html` 和 `http://example.com/b.html`这两个页面的document.domain都设成相同的域名就可以了。但要注意的是，document.domain的设置是有限制的，我们只能把document.domain设置成自身或更高一级的父域，且主域必须相同。
