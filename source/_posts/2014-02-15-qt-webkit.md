...
C++:
    ...
    class MyObject : [QObject](https://qt-project.org/doc/qt-5.0/qtcore/qobject.html) {
        Q_OBJECT
        Q_PROPERTY([QPixmap](https://qt-project.org/doc/qt-5.0/qtgui/qpixmap.html) myPixmap READ getPixmap)
    
    public:
        [QPixmap](https://qt-project.org/doc/qt-5.0/qtgui/qpixmap.html) getPixmap() const;
    };
...
QML [WebView](http://qt-project.org/doc/qt-5.0/qtwebkit/qml-qtwebkit3-webview.html) version 3.0 is incompatible with previous QML WebView API versions. It allows an application to load pages into the [WebView](http://qt-project.org/doc/qt-5.0/qtwebkit/qml-qtwebkit3-webview.html), either by URL or with an HTML string, and navigate within session history. By default, links to different pages load within the same [WebView](http://qt-project.org/doc/qt-5.0/qtwebkit/qml-qtwebkit3-webview.html), but applications may intercept requests to delegate links to other functions.
...
The [QtWebKit](http://qt-project.org/doc/qt-4.8/qtwebkit.html) Module has a QML element, [WebView](http://qt-project.org/doc/qt-4.8/qtwebkit.html) for displaying web content from a URL.
     ...
     [WebView](http://qt-project.org/doc/qt-4.8/qml-webview.html) {
...
- [QtWebKit QML Module](http://qt-project.org/doc/qt-4.8/qmlwebkit.html)
- [QML WebView Element](http://qt-project.org/doc/qt-4.8/qml-webview.html)
