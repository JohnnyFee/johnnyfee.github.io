...
From [11 Simple npm Tricks That Will Knock Your Wombat Socks Off](https://nodesource.com/blog/eleven-npm-tricks-that-will-knock-your-wombat-socks-off)
...
npm install --production # Strip your project's `devDependencies` for a production environment
```
...
- [Run npm scripts in a git pre-commit Hook by @elijahmanor](http://elijahmanor.com/npm-precommit-scripts)
